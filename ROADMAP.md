...
- [ ] Modulariser davantage `UiController` et réduire les dépendances croisées UI. En cours : modèles disponibilités, personnalisation profil et personnages extraits dans `js/ui/`.
