...
test.describe('Accueil - compteur Discord', () => {
  test('affiche le compteur Discord live quand l API repond', async ({ page }) => {
    ...
    await expect(page.locator('#home-version')).toHaveText('0.17.46');
...
test.describe('Accueil - patch notes', () => {
  test('affiche les derniers changements depuis l API changelog', async ({ page }) => {
    ...
    await expect(page.locator('.home-changelog-item').first()).toContainText('Version 0.17.46 - Publication version et changelog');
