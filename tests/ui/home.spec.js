...
test.describe('Accueil - patch notes', () => {
  test('affiche les derniers changements depuis l API changelog', async ({ page }) => {
        ...
        entries: [
          {
            ...
            summary: 'Les sessions du planning peuvent recevoir les reponses.'
          }
        ]
      })
    }));
    ...
    await expect(page.locator('.home-changelog-item').first()).toContainText('Version 0.17.40 - Reponses agenda planning');
