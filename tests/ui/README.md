...
4. **Frise chronologique** : vérifie le chargement de la page `/timeline/`, l’affichage du détail actif et les filtres principaux.
...
- `tests/ui/timeline.spec.js` : chronologie dédiée et filtres.
