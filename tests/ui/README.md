...
5. Planning : page dédiée, vue semaine/mois, saisie des disponibilités, synthèse des créneaux communs, sauvegarde profil et lisibilité mobile.
...
- `tests/ui/planning.spec.js` : planning JDR dédié.
